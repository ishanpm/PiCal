...
var grammar = {
    ...
    {"name": "i", "symbols": [{"literal":"*"}, "_", "n", {"literal":":"}, "c"], "postprocess": a => ["*:",a[2],a[4]]},
    ...
    {"name": "eprefix", "symbols": ["c", {"literal":"|"}, "_"], "postprocess": a => a[0]},
    {"name": "uprefix", "symbols": [], "postprocess": a => [null,null,[],[null]]},
    {"name": "uprefix$ebnf$1$subexpression$1", "symbols": [{"literal":"*"}, "_", "n"], "postprocess": a=> a[2]},
    ...
    {"name": "uprefix$ebnf$2$subexpression$1", "symbols": [{"literal":"!"}, "_", "n"], "postprocess": a=> a[2]},
    ...
    {"name": "uprefix$ebnf$3$subexpression$1", "symbols": [{"literal":"+"}, "_", "n"], "postprocess": a=> a[2]},
    {"name": "uprefix$ebnf$3", "symbols": ["uprefix$ebnf$3", "uprefix$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "uprefix$ebnf$4", "symbols": []},
    {"name": "uprefix$ebnf$4$subexpression$1", "symbols": [{"literal":"-"}, "_", "c"], "postprocess": a=> a[2]},
    {"name": "uprefix$ebnf$4", "symbols": ["uprefix$ebnf$4", "uprefix$ebnf$4$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "uprefix", "symbols": ["uprefix$ebnf$1", "uprefix$ebnf$2", "uprefix$ebnf$3", "uprefix$ebnf$4", {"literal":"|"}, "_"], "postprocess": a => [a[0],a[1],a[2],a[3]]},
